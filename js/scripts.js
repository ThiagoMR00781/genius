...
const startGame = () => {
	const _soundStartGame = "audio/startGame.mp3"
	const audioStartGame = new Audio(_soundStartGame);
	blink("--", () => {
		newColor();
		playSequence();
	})
...
const resetOrPlayAgain = () => {
	const _soundError = "audio/error.mp3"
	const audioError = new Audio(_soundError);
